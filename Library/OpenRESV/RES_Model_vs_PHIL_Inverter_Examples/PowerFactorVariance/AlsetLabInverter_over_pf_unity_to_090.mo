within OpenRESV.RES_Model_vs_PHIL_Inverter_Examples.PowerFactorVariance;
model AlsetLabInverter_over_pf_unity_to_090
  extends Modelica.Icons.Example;
  OpenRESV.Electrical.Renewables.PSSE.PV_with_inputs pV_with_inputs1(
    V_b=352.01,
  ...
  OpenRESV.Electrical.Buses.Bus InverterBus(V_b=352.01)
  ...
  Modelica.Blocks.Sources.CombiTimeTable EXPERIMENT_VOLTAGE_MAGNITUDE_pu(table=[
        0.10394,1; 0.21191,1; 0.27504,0.99999; 0.43032,0.99999; 0.49293,1;
        0.63284,1; 0.69452,0.99998; 0.80388,0.99998; 0.88288,0.99999; 1.0069,
        0.99999; 1.0862,1; 1.2128,1; 1.2748,0.99999; 1.4314,0.99999; 1.5094,
        0.99998; 1.652,0.99998; 1.7761,0.99998; 1.8686,0.99999; 2.0189,0.99999;
        2.0951,0.99998; 2.2188,0.99998; 2.2799,0.99998; 2.4037,0.99998; 2.5117,
        0.99998; 2.653,0.99999; 2.778,0.99999; 2.8738,0.99999; 3.0129,0.99999;
        3.0909,0.99999; 3.2158,0.99999; 3.2948,0.99999; 3.4339,0.99999; 3.5744,
        0.99998; 3.6518,0.99999; 3.7763,0.99999; 3.8711,0.99999; 4.0125,0.99999;
        4.089,0.99998; 4.2131,0.99998; 4.2748,0.99999; 4.4313,0.99999; 4.5094,
        0.99999; 4.6499,0.99999; 4.7116,0.99999; 4.8362,0.99999; 4.8985,0.99999;
        5.0695,0.99999; 5.1806,0.99999; 5.2447,0.99999; 5.3066,0.99999; 5.4456,
        0.99999; 5.5829,0.99999; 5.657,0.99999; 5.779,0.99999; 5.84,0.99999;
        5.9807,0.99999; 6.0437,0.99999; 6.1205,0.99999; 6.2557,0.99999; 6.3023,
        0.99999; 6.439,0.99999; 6.5762,0.99998; 6.652,0.99999; 6.7135,0.99999;
        6.8218,0.99998; 6.8988,0.99998; 7.0238,0.99998; 7.0861,1.0001; 7.2262,
        1.0001; 7.2882,1.0005; 7.4292,1.0005; 7.5831,1.0009; 7.6604,1.0013;
        7.7068,1.0013; 7.831,1.0018; 7.9067,1.0018; 8.043,1.0023; 8.1203,1.0023;
        8.2429,1.0027; 8.3055,1.0027; 8.4445,1.0027; 8.5852,1.0028; 8.6631,
        1.0028; 8.7861,1.0028; 8.849,1.0028; 8.912,1.0028; 9.0539,1.0028;
        9.1008,1.0028; 9.2395,1.0028; 9.3008,1.0028; 9.4264,1.0028; 9.5058,
        1.0028; 9.6443,1.0028; 9.7068,1.0028; 9.8293,1.0028; 9.8919,1.0028;
        10.048,1.0028; 10.111,1.0028; 10.222,1.0028; 10.283,1.0028; 10.408,
        1.0028; 10.47,1.0028; 10.58,1.0028; 10.64,1.0028; 10.703,1.0028; 10.811,
        1.0028; 10.873,1.0028; 11.013,1.0028; 11.092,1.0028; 11.216,1.0028;
        11.277,1.0028; 11.416,1.0028; 11.509,1.0028; 11.634,1.0028; 11.696,
        1.0028; 11.837,1.0028; 11.899,1.0028; 12.04,1.0028; 12.103,1.0028;
        12.212,1.0028; 12.274,1.0028; 12.397,1.0028], extrapolation=
        Modelica.Blocks.Types.Extrapolation.LastTwoPoints)
    annotation (Placement(transformation(extent={{114,-22},{94,-2}})));
  Modelica.Blocks.Sources.CombiTimeTable EXPERIMENT_VOLTAGE_ANGLE(table=[0.10394,
        -0.52389; 0.21191,-0.52389; 0.27504,-0.52389; 0.43032,-0.52389; 0.49293,
        -0.52389; 0.63284,-0.52383; 0.69452,-0.52383; 0.80388,-0.52389; 0.88288,
        -0.52389; 1.0069,-0.52383; 1.0862,-0.52383; 1.2128,-0.52377; 1.2748,
        -0.52377; 1.4314,-0.52389; 1.5094,-0.52389; 1.652,-0.52389; 1.7761,
        -0.52389; 1.8686,-0.52389; 2.0189,-0.52389; 2.0951,-0.52389; 2.2188,
        -0.52383; 2.2799,-0.52383; 2.4037,-0.52389; 2.5117,-0.52389; 2.653,
        -0.52383; 2.778,-0.52383; 2.8738,-0.52389; 3.0129,-0.52377; 3.0909,
        -0.52377; 3.2158,-0.52389; 3.2948,-0.52389; 3.4339,-0.52383; 3.5744,
        -0.52383; 3.6518,-0.52383; 3.7763,-0.52383; 3.8711,-0.52383; 4.0125,
        -0.52389; 4.089,-0.52389; 4.2131,-0.52389; 4.2748,-0.52389; 4.4313,
        -0.52383; 4.5094,-0.52383; 4.6499,-0.52389; 4.7116,-0.52389; 4.8362,
        -0.52389; 4.8985,-0.52389; 5.0695,-0.52389; 5.1806,-0.52389; 5.2447,
        -0.52377; 5.3066,-0.52377; 5.4456,-0.52389; 5.5829,-0.52389; 5.657,
        -0.52389; 5.779,-0.52389; 5.84,-0.52389; 5.9807,-0.52389; 6.0437,-0.52389;
        ...
        10.47,-0.52401; 10.58,-0.52401; 10.64,-0.52401; 10.703,-0.52401; 10.811,
        -0.52401; 10.873,-0.52401; 11.013,-0.52401; 11.092,-0.52401; 11.216,
        -0.52401; 11.277,-0.52401; 11.416,-0.52401; 11.509,-0.52401; 11.634,
        -0.52401; 11.696,-0.52401; 11.837,-0.52401; 11.899,-0.52401; 12.04,
        -0.52401; 12.103,-0.52401; 12.212,-0.52401; 12.274,-0.52401; 12.397,
        -0.52401], extrapolation=Modelica.Blocks.Types.Extrapolation.LastTwoPoints)
    annotation (Placement(transformation(extent={{114,-42},{94,-22}})));
  Modelica.Blocks.Math.Cos COS
    annotation (Placement(transformation(extent={{74,-58},{66,-50}})));
...
equation
  connect(pV_with_inputs1.pwPin, InverterBus.p)
    annotation (Line(points={{-28,-20},{-24,-20}}, color={0,0,255}));
  connect(GridBus.p, voltageSourceReImInput.p)
    annotation (Line(points={{8,-20},{13,-20}}, color={0,0,255}));
  connect(current_low_side.y,angle_low. u)
    annotation (Line(points={{1,50},{18,50}},      color={0,0,127}));
  connect(pwLine.p, InverterBus.p)
    annotation (Line(points={{-17,-20},{-24,-20}}, color={0,0,255}));
  connect(pV_with_inputs1.Pinput,gain. y) annotation (Line(points={{-50,-20},
          {-62,-20},{-62,-30},{-67.6,-30}},
                                          color={0,0,127}));
  connect(pV_with_inputs1.Qinput,gain1. y) annotation (Line(points={{-50,-14},
          {-62,-14},{-62,0},{-67.6,0}},              color={0,0,127}));
  connect(EXPERIMENT_P.y[1], gain.u)
    annotation (Line(points={{-89,-30},{-76.8,-30}}, color={0,0,127}));
  connect(EXPERIMENT_Q.y[1], gain1.u) annotation (Line(points={{-89,0},{-76.8,
          0}},                                color={0,0,127}));
  connect(EXPERIMENT_VOLTAGE_ANGLE.y[1], COS.u) annotation (Line(points={{
          93,-32},{92,-32},{92,-54},{74.8,-54}}, color={0,0,127}));
  connect(SIN.u, EXPERIMENT_VOLTAGE_ANGLE.y[1]) annotation (Line(points={{
          74.8,-42},{92,-42},{92,-32},{93,-32}}, color={0,0,127}));
  connect(voltageSourceReImInput.vRe,product1. y)
    annotation (Line(points={{36,-16},{46,-16},{46,-11},{51.7,-11}},
                                                         color={0,0,127}));
  connect(voltageSourceReImInput.vIm,product2. y)
    annotation (Line(points={{36,-24},{46,-24},{46,-31},{51.7,-31}},
                                                         color={0,0,127}));
  connect(COS.y,product1. u2) annotation (Line(points={{65.6,-54},{58,-54},
          {58,-76},{126,-76},{126,10},{58.6,10},{58.6,-9.2}},
                                                   color={0,0,127}));
  connect(EXPERIMENT_VOLTAGE_MAGNITUDE_pu.y[1], product1.u1) annotation (
      Line(points={{93,-12},{64,-12},{64,-12.8},{58.6,-12.8}}, color={0,0,
          127}));
  connect(SIN.y,product2. u1) annotation (Line(points={{65.6,-42},{62,-42},
          {62,-32.8},{58.6,-32.8}},
                        color={0,0,127}));
  connect(product2.u2, EXPERIMENT_VOLTAGE_MAGNITUDE_pu.y[1]) annotation (
      Line(points={{58.6,-29.2},{93,-29.2},{93,-12}}, color={0,0,127}));
  connect(pwLine.n, GridBus.p)
    annotation (Line(points={{1,-20},{8,-20}}, color={0,0,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,
            -80},{140,80}})),                                    Diagram(
        coordinateSystem(preserveAspectRatio=false, extent={{-140,-80},{140,
            80}})),
    experiment(
      StopTime=12.4,
      __Dymola_NumberOfIntervals=1000,
      __Dymola_Algorithm="Dassl"));
end AlsetLabInverter_over_pf_unity_to_090;
