...
partial model LoadTestBase "Base class for the different load cases."
  ...
  OpenRESV.Electrical.Branches.PwLine pwLine1(
    ...
    G=0,
    R=0.01,
    X=0.1) annotation (Placement(transformation(origin={10,-10}, extent={{
            -10,-10},{10,10}})));
  OpenRESV.Electrical.Buses.Bus bus1 annotation (Placement(transformation(
          origin={-10,0}, extent={{-10,-10},{10,10}})));
  OpenRESV.Electrical.Buses.Bus bus3 annotation (
    Placement(transformation(origin = {70, 0}, extent = {{-10, -10}, {10, 10}})));
  OpenRESV.Electrical.Buses.Bus bus2 annotation (
