within OpenRESV.Electrical.Machines.PSAT.BaseClasses;
partial model baseMachine "Base machine for PSAT models"
  ...
  import Complex;
  parameter OpenRESV.Types.ApparentPower Sn "Power rating"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.Voltage Vn "Voltage rating"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit ra "Armature resistance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit x1d "d-axis transient reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.Time M
    "Mechanical starting time, 2H [Ws/VA]"
    annotation (Dialog(group="Machine parameters"));
...
protected
  OpenRESV.Types.PerUnit pe(start=pm00)
    "electrical power transmitted through the air-gap";
  OpenRESV.Types.PerUnit vf_MB=vf*V_b/Vn
    "field voltage on machine base";
  parameter OpenRESV.Types.AngularVelocity w_b=2*Modelica.Constants.pi
      *fn "Base frequency in rad/s";
  ...
  parameter OpenRESV.Types.PerUnit p0=P_0/S_b
    "Initial active power generation in pu (system base)";
  parameter OpenRESV.Types.PerUnit q0=Q_0/S_b
  ...
  parameter OpenRESV.Types.PerUnit vr0=CM.real(Vt0) "Init. val.";
  parameter OpenRESV.Types.PerUnit vi0=CM.imag(Vt0) "Init. val.";
  parameter OpenRESV.Types.PerUnit ir0=-CM.real(I0) "Init. val.";
  parameter OpenRESV.Types.PerUnit ii0=-CM.imag(I0) "Init. val.";

  // Initialize DQ-quantities (machine base)
  parameter OpenRESV.Types.PerUnit xq0
    "used for setting the initial rotor angle";
  parameter OpenRESV.Types.Angle delta0=CM.arg((Vt0 + ((ra + CM.j*xq0)
      *Z_MBtoSB*I0))) "Init. val. rotor angle";
  ...
  parameter Complex Idq0=I0*CM.fromPolar(1/I_MBtoSB, (-delta0 + (Modelica.Constants.pi
                                                                     /2)))
    "(pu, machine base)";
  parameter OpenRESV.Types.PerUnit vd0=CM.real(Vdq0) "Init. val.";
  parameter OpenRESV.Types.PerUnit vq0=CM.imag(Vdq0) "Init. val.";
  parameter OpenRESV.Types.PerUnit id0=CM.real(Idq0) "Init. val.";
  parameter OpenRESV.Types.PerUnit iq0=CM.imag(Idq0) "Init. val.";

  parameter OpenRESV.Types.PerUnit pm00=((vq0 + ra*iq0)*iq0 + (vd0 +
      ra*id0)*id0)/S_SBtoMB "Initial value (system base)";
