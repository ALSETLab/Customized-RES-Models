...
partial model pfComponent
  ...
  parameter OpenRESV.Types.Voltage V_b=400e3 "Base voltage of the bus"
  ...
  parameter Boolean enableV_b = false
    ...
    annotation (
      Dialog(
        ...
        __Dymola_compact=true,
        __Dymola_descriptionLabel=true), choices(checkBox=true));
  parameter OpenRESV.Types.Frequency fn=SysData.fn "System frequency"
  ...
  parameter Boolean enablefn = false
    ...
    annotation (
      Dialog(
        ...
        __Dymola_compact=true,
        __Dymola_descriptionLabel=true), choices(checkBox=true));
  parameter OpenRESV.Types.ActivePower P_0=1e6 "Initial active power"
  ...
  parameter Boolean enableP_0 = false
    ...
    annotation (
      Dialog(
        ...
        __Dymola_compact=true,
        __Dymola_descriptionLabel=true), choices(checkBox=true));
  parameter OpenRESV.Types.ReactivePower Q_0=0 "Initial reactive power"
  ...
  parameter Boolean enableQ_0 = false
    ...
    annotation (
      Dialog(
        ...
        __Dymola_compact=true,
        __Dymola_descriptionLabel=true), choices(checkBox=true));
  parameter OpenRESV.Types.PerUnit v_0=1 "Initial voltage magnitude"
  ...
  parameter Boolean enablev_0 = false
    ...
    annotation (
      Dialog(
        ...
        __Dymola_compact=true,
        __Dymola_descriptionLabel=true), choices(checkBox=true));
  parameter OpenRESV.Types.Angle angle_0=0 "Initial voltage angle"
