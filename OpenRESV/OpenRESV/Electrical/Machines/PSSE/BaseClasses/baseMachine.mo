within OpenRESV.Electrical.Machines.PSSE.BaseClasses;
partial model baseMachine "Base machine for PSSE models"
  ...
  //Machine parameters
  parameter OpenRESV.Types.ApparentPower M_b "Machine base power"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.Time Tpd0
    "d-axis transient open-circuit time constant"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.Time Tppd0
    "d-axis sub-transient open-circuit time constant"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.Time Tppq0
    "q-axis sub-transient open-circuit time constant"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.Time H "Inertia constant"
    annotation (Dialog(group="Machine parameters"));
  parameter Real D "Speed damping"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit Xd "d-axis reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit Xq "q-axis reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit Xpd "d-axis transient reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit Xppd
    "d-axis sub-transient reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit Xppq
    "q-axis sub-transient reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit Xl "leakage reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit S10 "Saturation factor at 1.0 pu"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit S12 "Saturation factor at 1.2 pu"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit R_a=0 "Armature resistance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit w0(min=-1 + Modelica.Constants.eps)
    =0 "Initial speed deviation from nominal"
  ...
  RealOutput XADIFD "Machine field current [pu]" annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        origin={110,-90})));
  OpenRESV.Types.PerUnit w(start=w0, fixed=true)
    "Machine speed deviation";
  OpenRESV.Types.Angle delta "Rotor angle";
  OpenRESV.Types.PerUnit Vt(start=v_0) "Bus voltage magnitude";
  OpenRESV.Types.Angle anglev(start=angle_0) "Bus voltage angle";
  OpenRESV.Types.PerUnit I(start=sqrt(ir0^2 + ii0^2))
    "Terminal current magnitude";
  OpenRESV.Types.Angle anglei(start=atan2(ii0, ir0))
    "Terminal current angle";
  OpenRESV.Types.PerUnit P(start=P_0/S_b)
    "Active power (system base)";
  OpenRESV.Types.PerUnit Q(start=Q_0/S_b)
    "Reactive power (system base)";
  OpenRESV.Types.PerUnit Te "Electrical torque [pu]";
  OpenRESV.Types.PerUnit id "d-axis armature current [pu]";
  OpenRESV.Types.PerUnit iq "q-axis armature current [pu]";
  OpenRESV.Types.PerUnit ud "d-axis terminal voltage [pu]";
  OpenRESV.Types.PerUnit uq "q-axis terminal voltage [pu]";
protected
  parameter OpenRESV.Types.AngularVelocity w_b=2*Modelica.Constants.pi
      *fn "System base speed";
