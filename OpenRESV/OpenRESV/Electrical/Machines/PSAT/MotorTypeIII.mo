...
model MotorTypeIII "Induction Machine - Order III"
  ...
  parameter OpenRESV.Types.Time Hm=3 "Inertia constant"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit a=0.25 "1st coefficient of tau_m(w)"
    annotation (Dialog(group="Machine parameters"));
  ...
  OpenRESV.Types.PerUnit anglev(start=angle_0) "Bus voltage angle";
  ...
  OpenRESV.Types.PerUnit epr(start=epr0);
  OpenRESV.Types.PerUnit epm(start=epm0);
  OpenRESV.Types.PerUnit I;
  OpenRESV.Types.Angle anglei;
...
protected
  parameter OpenRESV.Types.AngularVelocity Omegab=2*pi*fn "Base freq";
  ...
  parameter OpenRESV.Types.PerUnit Xp=Xs + Xr1*Xm/(Xr1 + Xm);
  parameter OpenRESV.Types.Time Tp0=(Xr1 + Xm)/(Omegab*Rr1);
