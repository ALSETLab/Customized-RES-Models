...
model Order3 "Third Order Synchronous Machine with Inputs and Outputs"
  ...
  parameter OpenRESV.Types.PerUnit xd "d-axis synchronous reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.Time T1d0
    "d-axis open circuit transient time constant"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenRESV.Types.PerUnit xq "q-axis synchronous reactance"
    annotation (Dialog(group="Machine parameters"));
