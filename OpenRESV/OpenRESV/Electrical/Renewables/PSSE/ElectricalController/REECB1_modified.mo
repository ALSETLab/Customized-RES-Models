...
model REECB1_modified
  ...
  parameter OpenIPSL.Types.Time Tvpc = 0 "Filter time constant for voltage measurement (VPC)";
  parameter OpenIPSL.Types.PerUnit dbd1_vpc = -0.05 "Voltage error dead band lower threshold (VPC)";
  parameter OpenIPSL.Types.PerUnit dbd2_vpc = 0.05 "Voltage error dead band upper threshold (VPC)";
  parameter Real Kvpc = 0 "Reactive current injection gain during over and undervoltage conditions (VPC)";
  parameter OpenIPSL.Types.PerUnit Iqh_vpc = 1.05 "Upper limit on reactive current injection Iqinj (VPC))";
  parameter OpenIPSL.Types.PerUnit Iql_vpc= -1.05 "Lower limit on reactive current injection Iqinj (VPC)";
  ...
  OpenIPSL.NonElectrical.Continuous.SimpleLag simpleLag_VPC(
    K=1,
    T=Tvpc,
    y_start=V0)
