within OpenRESV.NonElectrical.Continuous;
block DerivativeLag "Derivative lag transfer function block"
  extends Modelica.Blocks.Interfaces.SISO;
  parameter Real K "Gain";
  parameter OpenIPSL.Types.Time T "Time constant";
...
protected
  parameter OpenIPSL.Types.Time T_dummy=if abs(T) < Modelica.Constants.eps
       then 1000 else T "Lead time constant";
  parameter OpenIPSL.Types.Time K_dummy=if abs(K) < Modelica.Constants.eps
