...
partial model MachineTestBase "Base class for tests involving machines."
  OpenRESV.Electrical.Branches.PwLine pwLine1(
    ...
    B=0.0005) annotation (Placement(transformation(origin={20,-12},
          extent={{-6,-6},{6,6}})));
  OpenRESV.Electrical.Branches.PwLine pwLinewithOpening1(
    G=0,
    R=0.01,
    X=0.1,
    opening=1,
  ...
  OpenRESV.Electrical.Loads.PSAT.PQ pwLoadPQ1(P_0=8000000, Q_0=6000000)
    annotation (Placement(transformation(
        origin={94,24},
        extent={{-6,-6},{6,6}},
        rotation=90)));
  OpenRESV.Electrical.Loads.PSAT.PQvar pwLoadPQ2(P_0=8000000, Q_0=6000000)
    annotation (Placement(transformation(
  ...
  OpenRESV.Electrical.Buses.Bus bus1
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  OpenRESV.Electrical.Buses.Bus bus2
    annotation (Placement(transformation(extent={{30,-10},{50,10}})));
  OpenRESV.Electrical.Buses.Bus bus3
    annotation (Placement(transformation(extent={{70,14},{90,34}})));
  OpenRESV.Electrical.Buses.Bus bus4
